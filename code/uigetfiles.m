function [filenames, pathname] = uigetfiles(filePat,comments)
...
filechooser = javax.swing.JFileChooser(thep);
filechooser.setMultiSelectionEnabled(true);
filechooser.setFileSelectionMode(filechooser.FILES_ONLY);
filechooser.setFileFilter(javax.swing.filechooser.FileNameExtensionFilter(comments,filePat));
